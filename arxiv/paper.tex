...
On a NVIDIA RTX 4090, our implementation achieves up to 325 TFLOPS on matrices up to $N=20480$, providing 75\% memory savings and $7.2\times$ speedup over 
...
\caption{RTX 4090 Large Scale Performance: Time-to-solution, throughput, error, and speedup vs matrix size ($\log_2$ scale). LowRank Auto achieves up to 325 TFLOPS at N=20480, becoming the fastest method for $N\geq10240$.}
